...
use atsicorp\HetznerCloud\APIException;
...
use atsicorp\HetznerCloud\Models\LoadBalancerTypes\LoadBalancerType;
...
class LoadBalancer extends Model implements Resource
{
    ...
    /**
     * @param  $input
     * @return \atsicorp\HetznerCloud\Models\LoadBalancers\LoadBalancer|static
     */
