...
namespace atsicorp\Tests\Unit\Models\FloatingIPs;

use GuzzleHttp\Psr7\Response;
use atsicorp\HetznerCloud\Models\FloatingIps\FloatingIp;
...
class FloatingIpTest extends TestCase
{
    ...
    public function testChangeReverseDNSSetToDefault()
    {
        ...
        $this->assertEquals('floating_ip', $apiResponse->action->resources[0]->type);
        $this->assertLastRequestEquals('POST', '/floating_ips/4711/actions/change_dns_ptr');
        $this->assertLastRequestBodyParametersEqual(['ip' => '1.2.3.4', 'dns_ptr' => null]);
    }
}
